...
class Assets extends CI_Controller{
  ...
  public function assets_category(){
    ...
    $this->load->view('Assets/assets_category');
    $this->load->view('Include/footer');
  }

  // Edit/Update Education Level...
  public function edit_assets_category($assets_category_id){
    $crm_user_id = $this->session->userdata('crm_user_id');
    $crm_company_id = $this->session->userdata('crm_company_id');
    $crm_role_id = $this->session->userdata('crm_role_id');
    if($crm_user_id == '' && $crm_company_id == ''){ header('location:'.base_url().'User'); }
  ...
  public function delete_assets_category($assets_category_id){
    $crm_user_id = $this->session->userdata('crm_user_id');
    $crm_company_id = $this->session->userdata('crm_company_id');
    $crm_role_id = $this->session->userdata('crm_role_id');
    if($crm_user_id == '' && $crm_company_id == ''){ header('location:'.base_url().'User'); }
    $this->User_Model->delete_info('assets_category_id', $assets_category_id, 'assets_category');
    $this->session->set_flashdata('delete_success','success');
    header('location:'.base_url().'Assets/assets_category');
  }
  ...
  public function delete_assets($assets_id){
    ...
    $this->session->set_flashdata('delete_success','success');
    header('location:'.base_url().'Assets/assets');
  }
