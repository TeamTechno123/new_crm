...
class Payment_Gateway extends CI_Controller{
  ...
  public function payment_gateway(){
    ...
    $this->load->view('Payment_Gateway/payment_gateway');
  ...
  public function delete_payment_gateway($payment_gateway_id){
    ...
    $crm_role_id = $this->session->userdata('crm_role_id');
    if($crm_user_id == '' && $crm_company_id == ''){ header('location:'.base_url().'User'); }
    $this->User_Model->delete_info('payment_gateway_id', $payment_gateway_id, 'payment_gateway');
    $this->session->set_flashdata('delete_success','success');
    header('location:'.base_url().'Payment_Gateway/payment_gateway');
  }
