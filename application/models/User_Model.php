...
class User_Model extends CI_Model{
  ...
  public function get_info_arr_fields2($fields, $col_name1, $val1, $col_name2, $val2, $col_name3, $val3, $tbl_name){
    $this->db->select($fields);
    if($col_name1 != ''){
...
// Get Branch List...
  public function get_branch_list($branch_id_arr){
    $branch_id_arr = explode(",",$branch_id_arr);
