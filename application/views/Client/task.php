      ...
      <div class="container-fluid">
        <div class="row">
                      ...
                      <div class="form-group col-md-6 select_sm">
                        <div class="row">
                          ...
                          <div class="form-group col-md-6 select_sm">
                            ...
                            <input type="text" class="form-control form-control-sm" name="estimated_hours" id="estimated_hours"  placeholder="Estimated Hours" required>
                          </div>
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header border-transparent">
                <h3 class="card-title">List All Worksheet </h3>
              </div>
