          ...
          <div class="col-md-12">
            ...
            <div class="row">
              <div class="col-md-5">
                <div class="card card-default">
                  <div class="card-header">
                    <h5 class="card-title f-16"> Add New Events</h5>
                  </div>
                  <form class="m-0 input_form" id="form_action" role="form" action="" method="post">
                    <div class="card-body row">
                      ...
                      <div class="form-group col-md-12 select_sm">
                        ...
                        <input type="text" class="form-control form-control-sm" name="event_title" id="event_title"  placeholder="Event Title" required>
                      </div>

                      <div class="form-group col-md-6 select_sm">
                        <label>Event Date</label>
                        <input type="text" class="form-control form-control-sm" name="event_date" id="event_date"  placeholder="Event Date" required>
                      </div>

                      <div class="form-group col-md-6 select_sm">
                        <label>Event Time</label>
                        <input type="text" class="form-control form-control-sm" name="event_time" id="event_time"  placeholder="Event Time" required>
                      </div>
              ...
              <div class="col-md-7">
                <div class="card card-default">
                  <div class="card-header">
                    <h5 class="card-title f-16">List All Events</h5>
                  </div>
