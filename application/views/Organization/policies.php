          ...
          <div class="col-md-12">
            ...
            <div class="row">
              <div class="col-md-5">
                <div class="card card-default">
                  <div class="card-header">
                    <h5 class="card-title f-16"> Add New Policies</h5>
                  </div>
                  <form class="m-0 input_form" id="form_action" role="form" action="" method="post">
                    <div class="card-body row">
                      ...
                      <div class="form-group col-md-12 select_sm">
                        <label> Title</label>
                        <input type="text" class="form-control form-control-sm" name="policy_title" id="policy_title"  placeholder=" Title" required>
                      </div>

                      <div class="form-group col-md-12 select_sm">
                        <label> Description</label>
                      <textarea class="form-control form-control-sm" name="name" rows="4" cols="80"></textarea>
                     </div>
              ...
              <div class="col-md-7">
                <div class="card card-default">
                  <div class="card-header">
                    <h5 class="card-title f-16">List All Policies</h5>
                  </div>
