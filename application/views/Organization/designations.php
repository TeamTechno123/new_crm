          ...
          <div class="col-md-12">
            ...
            <div class="row">
              <div class="col-md-5">
                <div class="card card-default">
                  <div class="card-header">
                    <h5 class="card-title f-16"> Add New Designations</h5>
                  </div>
                  <form class="m-0 input_form" id="form_action" role="form" action="" method="post">
                    <div class="card-body row">
                      ...
                      <div class="form-group col-md-12 select_sm">
                        ...
                        <input type="text" class="form-control form-control-sm" name="designation_name" id="designation_name"  placeholder=" Designation Name" required>
                      </div>
              ...
              <div class="col-md-7">
                <div class="card card-default">
                  <div class="card-header">
                    <h5 class="card-title f-16">List All Designations</h5>
                  </div>
