                ...
                <ul class="nav nav-pills flex-column master_menu">
                  <li class="nav-item">
                    <a href="<?php echo base_url(); ?>Staff/expired_document" class="nav-link">
                      <i class="far fa-edit"></i> All Departments
                    </a>
                  </li>

                  <li class="nav-item active">
                    <a href="<?php echo base_url(); ?>Staff/immigration" class="nav-link">
                      <i class="fas fa-inbox"></i> MD Office
                    </a>
                  </li>

                  <li class="nav-item active">
                    <a href="<?php echo base_url(); ?>Staff/official_document" class="nav-link">
                      <i class="fas fa-inbox"></i> Account and Finances
                    </a>
                  </li>
              ...
              <div class="col-md-12">
                <div class="card card-default">
                  <div class="card-header">
                    <h5 class="card-title f-16"> Add New File</h5>
                  </div>
                ...
                <div class="card card-default">
                  <div class="card-header">
                    <h5 class="card-title f-16">List All File Manager</h5>
                  </div>
