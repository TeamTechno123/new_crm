                    ...
                    <div class="row px-3">
                      ...
                      <div class="form-group col-md-6 select_sm">
                        <div class="row">
                          ...
                          <div class="form-group col-md-6 select_sm">
                            <label>Quoted Project No. </label>
                            <input type="text" class="form-control form-control-sm" name="project_no" id="project_no"  placeholder="Quoted Project No. " required>
                          </div>
                          ...
                          <div class="form-group col-md-12 select_sm">
                            ...
                            <input type="text" class="form-control form-control-sm" name="est_date" id="est_date"  placeholder="Estimate Date" required>
                          </div>

                          <div class="form-group col-md-6 select_sm">
                            <label>Estimate Hours </label>
                            <input type="text" class="form-control form-control-sm" name="est_hours" id="est_hours"  placeholder="Estimate Hours" required>
                          </div>
