      ...
      <div class="container-fluid">
        <div class="row">
                    ...
                    <div class="row px-3">
                      <div class="form-group col-md-7 select_sm">
                        <div class="row">
                          ...
                          <div class="form-group col-md-4 select_sm">
                            <label>Payee Option</label>
                            <select class="form-control select2" name="payee_option" id="payee_option" data-placeholder="Payee Option">
                              <option value="">Payee Option</option>
                            </select>
                          </div>

                          <div class="form-group col-md-4 select_sm">
                            <label>Payee </label>
                            <select class="form-control select2" name="payee" id="payee" data-placeholder="Payee ">
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header border-transparent">
                <h3 class="card-title">List All Expense</h3>
              </div>
