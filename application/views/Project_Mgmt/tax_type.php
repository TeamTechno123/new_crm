          ...
          <div class="col-md-12">
            ...
            <div class="row">
              <div class="col-md-5">
                <div class="card card-default">
                  <div class="card-header">
                    <h5 class="card-title f-16"> Add New Tax Type</h5>
                  </div>
                  <form class="m-0 input_form" id="form_action" role="form" action="" method="post">
                    <div class="card-body row">
                      <div class="form-group col-md-12">
                        <label>Tax Name</label>
                        <input type="text" class="form-control form-control-sm" name="tax_name" id="tax_name" value="" placeholder="Tax Name" required>
                      </div>

                      <div class="form-group col-md-12">
                        <label>Tax Rate</label>
                        <input type="text" class="form-control form-control-sm" name="tax_rate" id="tax_rate" value="" placeholder="Tax Rate" required>
                      </div>

                      <div class="form-group col-md-12 select_sm">
                        <label>Tax Type</label>
                        <select class="form-control select2" name="tax_type" id="tax_type" data-placeholder="Tax Type">
              ...
              <div class="col-md-7">
                <div class="card card-default">
                  <div class="card-header">
                    <h5 class="card-title f-16">List All Tax Type</h5>
                  </div>
