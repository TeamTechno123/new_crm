                    ...
                    <div class="row px-3">
                      ...
                      <div class="form-group col-md-6 select_sm">
                        <div class="row">
                          ...
                          <div class="form-group col-md-12 select_sm">
                            <label>Title</label>
                            <select class="form-control select2" name="title" id="title" data-placeholder="Title">
                          ...
                          <div class="form-group col-md-6 select_sm">
                            ...
                            <input type="text" class="form-control form-control-sm" name="est_hour" id="est_hour"  placeholder="Estimated Hour" required>
                          </div>
                          ...
                          <div class="form-group col-md-12 select_sm">
                            ...
                            <input type="text" class="form-control form-control-sm" name="assign_to" id="assign_to"  placeholder="Assign to" required>
                          </div>
