          ...
          <div class="col-md-12">
            <div class="card collapsed-card">
              <div class="card-header border-transparent">
                <h3 class="card-title">Add New Warning</h3>
                      ...
                      <div class="form-group col-md-6 select_sm">
                        <div class="row">
                          ...
                          <div class="form-group col-md-6 select_sm">
                            ...
                            <input type="text" class="form-control form-control-sm" name="date" id="date"  placeholder="Warning Type" required>
                          </div>

                          <div class="form-group col-md-6 select_sm">
                            <label>Subject</label>
                            <input type="text" class="form-control form-control-sm" name="date" id="date"  placeholder="Subject" required>
                          </div>
                        ...
                        <div class="row">
                          <div class="form-group col-md-12 select_sm">
                            ...
                            <div class="form-group col-md-6 select_sm">
                              ...
                              <input type="text" class="form-control form-control-sm" name="month_year" id="month_year"  placeholder="Warning By" required>
                            </div>

                            <div class="form-group col-md-6 select_sm">
                              <label>Warning Subject</label>
                              <input type="text" class="form-control form-control-sm" name="warining_subject" id="warining_subject"  placeholder="Warning Subject" required>
                            </div>
