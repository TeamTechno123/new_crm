          ...
          <div class="col-md-12">
            <div class="card collapsed-card">
              <div class="card-header border-transparent">
                <h3 class="card-title">Add New Pramotions</h3>
                      ...
                      <div class="form-group col-md-6 select_sm">
                        <div class="row">
                          ...
                          <div class="form-group col-md-6 select_sm">
                            ...
                            <select class="form-control select2" name="award_type" id="award_type" data-placeholder="Designation">
                              <option value=""> Designation</option>
                            </select>
                          </div>

                          <div class="form-group col-md-6 select_sm">
                            <label>Pramotion Title</label>
                            <input type="text" class="form-control form-control-sm" name="gift" id="gift"  placeholder="Pramotion Title" required>
                          </div>

                          <div class="form-group col-md-6 select_sm">
                            <label>Pramotion Date</label>
                            <input type="text" class="form-control form-control-sm" name="date" id="date"  placeholder="Pramotion Date" required>
                          </div>
